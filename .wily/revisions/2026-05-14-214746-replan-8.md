...
Reason: Add self-update implementation and Codex app watch strategy phases
...
Next action:
- Added phase 10-1: Zip bootstrap에서 GitHub self-update 경로 제공.
- Added phase 10-2: Codex app 환경의 wily-watch 전략 확정.
- Start 10-1 first, then use 10-2 to decide the Codex app watch UX after the update path exists.
