...
Reason: Roadmap watch 접기/펼치기 UX를 왼쪽 버튼 단일 토글과 펼친 상태 스크롤 지원으로 보정
...
Next action:
- Added phase 12-1: Watch pane 왼쪽 버튼 토글과 펼친 상태 스크롤 보정.
- Use 12-1 to restrict expand/collapse to left-click only and add mouse-wheel scrolling for expanded completed-stage content.
- Preserve completed 08-1 watch interaction history; this is a follow-up UX correction.
